...
class IqdbElement {
    ...
    public IqdbMatch explode(IqdbMatchType matchType) {
        ...
        ImageRatios resolution = getImageRatio(resolutionAndRatingText);
    ...
    private ImageRatios getImageRatio(String resolutionAndRating) {
        String resolution = resolutionAndRating.substring(0, resolutionAndRating.indexOf(" ["));
        return ImageRatios.getImageRatio(resolution);
    }
