...
//        Assert.assertEquals(36821, count);
    ...
    public void testBooruLookup() {
        try {
            ...
            System.out.println("shit fucked up" + e.getMessage() + e.getCause() + e.getStackTrace());
        }
    ...
    private void processTable(Element element) {
        ...
        if (tableDatas.size() != 4) {
            System.out.println("the table should have 4 table datas what the fuck happened");
            System.out.println(tableDatas.toString());
        }
        ...
        System.out.println(image.getElementsByTag("a").get(0).attr("href").toString());
        System.out.println(image.getElementsByTag("img").get(0).attr("alt").toString());
